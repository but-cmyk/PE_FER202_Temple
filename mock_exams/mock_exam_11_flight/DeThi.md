...
Bạn nhận được một project **Flight Booking App** đã được dựng sẵn cấu trúc. Project sử dụng:
- React 18 + Vite
- React-Bootstrap 2.x
...
|------|-----------|------|------|
| TODO-01 | Alert khi đăng nhập sai / Phân quyền giao diện theo role | `Login.jsx` + `FlightList.jsx` | 1,0 |
| TODO-02 | Hiển thị thông tin người dùng trên Navbar | `AppNavbar.jsx` | 1,0 |
| TODO-03 | Nút Logout hoặc Dropdown sắp xếp | `AppNavbar.jsx` + `FlightList.jsx` | 1,0 |
| TODO-04 | Dropdown Form thêm mới | `AddFlight.jsx` | 1,0 |
| TODO-05 | Trang chi tiết thực thể (Detail Page) | `FlightDetail.jsx` | 1,0 |
| TODO-06 | Xóa thực thể kèm ModalConfirm | `FlightRow.jsx` | 1,0 |
| TODO-07 | Định dạng cột dữ liệu trên dòng | `FlightRow.jsx` | 0,5 |
| TODO-08 | Footer hiển thị động | `AppFooter.jsx` | 0,5 |
| TODO-09 | Trang 404 hoặc Fetch song song | `NotFound.jsx` hoặc `AirlineDetail.jsx` | 1,0 |
| TODO-10A | Thêm danh mục | `ManageAirlines.jsx` | 1,0 |
| TODO-10B | Chặn xóa danh mục đang sử dụng | `ManageAirlines.jsx` | 1,0 |
| **Tổng** | | | **10,0** |
...
- **FlightList.jsx**: Lấy user từ AuthContext. Nếu role != 'Admin' thì ẩn nút "+ Add" và truyền canManage={false} xuống Row để ẩn nút Delete.
...
- Thêm dropdown sắp xếp (Sort by) Name / Duration (hours) / Price (tăng/giảm). Cập nhật phân trang và set page = 1.

### TODO-04 — Dropdown động Form thêm mới
- Gọi fetchAirlines() trong useEffect để đổ dữ liệu vào Dropdown chọn loại. Option đầu tiên là placeholder có value="".

### TODO-05 — Chi tiết thực thể
- Gọi API fetchFlightById, hiển thị Spinner khi loading, hiển thị Alert khi lỗi, hiển thị chi tiết thực thể và có nút Back.
