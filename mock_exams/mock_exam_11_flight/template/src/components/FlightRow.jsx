...
export default function FlightRow({ flight, index, onDelete, canManage }) {
    ...
    <tr>
      ...
      <td>
        <div className="d-flex gap-2">
          <Link to={`/flights/${flight.id}`} className="btn btn-sm btn-info text-white">
            View
          </Link>
