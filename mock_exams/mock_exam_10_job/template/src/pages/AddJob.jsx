...
import { fetchCompanies, addJob } from '../api/jobApi'
...
export default function AddJob() {
  ...
  const handleSubmit = async (e) => {
    ...
    const newItem = {
      ...
      location: textFieldVal,
      priceMin: Number(price1),
      priceMax: Number(price2),
      postedDate: dateFieldVal
    }

    try {
      const created = await addJob(newItem)
  ...
  return (
    <Container className="mt-4" style={{ maxWidth: '600px' }}>
      <Card>
        <Card.Header as="h5">Add New Job</Card.Header>
        <Card.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formNum">
              <Form.Label>Experience Required (yrs)</Form.Label>
