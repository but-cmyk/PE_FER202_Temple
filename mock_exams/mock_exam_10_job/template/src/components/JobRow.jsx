...
export default function JobRow({ job, index, onDelete, canManage }) {
  ...
  return (
    <tr>
      ...
      <td>{job.location}</td>
      <td>
        {formatPriceRange(job.priceMin, job.priceMax)}
        // === SOLUTION_END ===
      ...
      <td>
        <div className="d-flex gap-2">
          <Link to={`/jobs/${job.id}`} className="btn btn-sm btn-info text-white">
            View
          </Link>
