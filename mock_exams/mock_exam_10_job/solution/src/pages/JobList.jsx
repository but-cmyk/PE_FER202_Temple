...
export default function JobList() {
  ...
  const { jobs, companies, loading } = state
      ...
      <Row className="mb-3 align-items-center">
        ...
        <Col md={3}>
          {/* TODO-03: Dropdown Form.Select sắp xếp với aria-label="Sort by" */}
            ...
            <option value="num-asc">Experience Required (yrs) (Low-High)</option>
            <option value="num-desc">Experience Required (yrs) (High-Low)</option>
      ...
      <Table striped bordered hover>
        ...
        <tbody>
          {paginatedItems.map((item, idx) => (
            // TODO-01: Truyền canManage={isAdmin} xuống JobRow
                        <JobRow
              key={item.id}
              job={item}
