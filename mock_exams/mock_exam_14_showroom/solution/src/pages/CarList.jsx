...
export default function CarList() {
  ...
  const { cars, dealers, loading } = state
      ...
      <Row className="mb-3 align-items-center">
        ...
        <Col md={3}>
          {/* TODO-03: Dropdown Form.Select sắp xếp với aria-label="Sort by" */}
            ...
            <option value="num-asc">Model Year (Low-High)</option>
            <option value="num-desc">Model Year (High-Low)</option>
      ...
      <Table striped bordered hover>
        ...
        <tbody>
          {paginatedItems.map((item, idx) => (
            // TODO-01: Truyền canManage={isAdmin} xuống CarRow
                        <CarRow
              key={item.id}
              car={item}
