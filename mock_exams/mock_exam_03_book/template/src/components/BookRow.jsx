...
export default function BookRow({ book, index, onDelete, canManage }) {
  ...
  return (
    <tr>
      ...
      <td>{book.author}</td>
      <td>
        {formatPriceRange(book.priceMin, book.priceMax)}
        // === SOLUTION_END ===
      ...
      <td>
        <div className="d-flex gap-2">
          <Link to={`/books/${book.id}`} className="btn btn-sm btn-info text-white">
            View
          </Link>
