...
import { fetchCategories, addMovie } from '../api/movieApi'
...
export default function AddMovie() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const created = await addMovie(newItem)
  ...
  return (
    <Container className="mt-4" style={{ maxWidth: '600px' }}>
      <Card>
        <Card.Header as="h5">Add New Movie</Card.Header>
        <Card.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formPrice1">
              <Form.Label>Ticket Normal</Form.Label>
            ...
            <Form.Group className="mb-3" controlId="formPrice2">
              <Form.Label>Ticket IMAX</Form.Label>
