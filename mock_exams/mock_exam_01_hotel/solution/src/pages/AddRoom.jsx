...
import { fetchRoomTypes, addRoom } from '../api/roomApi'
...
export default function AddRoom() {
  ...
  // TODO-04: fetch danh sách loại thực thể từ API trong useEffect
    useEffect(() => {
    fetchRoomTypes().then(setTypes).catch(console.error)
  }, [])
  ...
  const handleSubmit = async (e) => {
    ...
    const newItem = {
      ...
      bedType: textFieldVal,
      priceWeekday: Number(price1),
      priceWeekend: Number(price2),
      lastServiced: dateFieldVal
    }

    try {
      const created = await addRoom(newItem)
  ...
  return (
    <Container className="mt-4" style={{ maxWidth: '600px' }}>
      <Card>
        <Card.Header as="h5">Add New Room</Card.Header>
        <Card.Body>
          <Form onSubmit={handleSubmit}>
            ...
            <Form.Group className="mb-3" controlId="formType">
              ...
              {/* TODO-04: render dropdown với option đầu tiên là -- Select -- */}
                ...
                <option value="">-- Select roomType type --</option>
                {types.map(t => (
            ...
            <Form.Group className="mb-3" controlId="formPrice1">
              <Form.Label>Price Weekday</Form.Label>
            ...
            <Form.Group className="mb-3" controlId="formPrice2">
              <Form.Label>Price Weekend</Form.Label>
