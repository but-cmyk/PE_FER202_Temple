...
export default function EmployeeRow({ employee, index, onDelete, canManage }) {
  ...
  return (
    <tr>
      ...
      <td>{employee.role}</td>
      <td>
        {formatVND(employee.priceWeekday)}
        // === SOLUTION_END ===
      ...
      <td>
        <div className="d-flex gap-2">
          <Link to={`/employees/${employee.id}`} className="btn btn-sm btn-info text-white">
            View
          </Link>
