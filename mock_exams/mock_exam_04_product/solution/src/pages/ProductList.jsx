...
export default function ProductList() {
  ...
  const { products, brands, loading } = state
  ...
  // Logic Sắp xếp
    ...
    switch (sortBy) {
      ...
      case 'num-asc':
        return Number(a.warranty) - Number(b.warranty)
      case 'num-desc':
        return Number(b.warranty) - Number(a.warranty)
      case 'price-asc':
      ...
      <Row className="mb-3 align-items-center">
        ...
        <Col md={3}>
          {/* TODO-03: Dropdown Form.Select sắp xếp với aria-label="Sort by" */}
            ...
            <option value="num-asc">Warranty (months) (Low-High)</option>
            <option value="num-desc">Warranty (months) (High-Low)</option>
      ...
      <Table striped bordered hover>
        ...
        <tbody>
          {paginatedItems.map((item, idx) => (
            // TODO-01: Truyền canManage={isAdmin} xuống ProductRow
                        <ProductRow
              key={item.id}
              product={item}
