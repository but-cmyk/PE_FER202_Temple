...
export default function ItemRow({ item, index, onDelete, canManage }) {
    ...
    <tr>
      ...
      <td>
        <div className="d-flex gap-2">
          <Link to={`/items/${item.id}`} className="btn btn-sm btn-info text-white">
            View
          </Link>
