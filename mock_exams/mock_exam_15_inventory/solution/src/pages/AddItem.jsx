...
import { fetchSuppliers, addItem } from '../api/itemApi'
...
export default function AddItem() {
  ...
  // TODO-04: fetch danh sách loại thực thể từ API trong useEffect
    useEffect(() => {
    fetchSuppliers().then(setTypes).catch(console.error)
  }, [])
  ...
  return (
    <Container className="mt-4" style={{ maxWidth: '600px' }}>
      <Card>
        <Card.Header as="h5">Add New Item</Card.Header>
        <Card.Body>
