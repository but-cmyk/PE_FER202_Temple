...
Bạn nhận được một project **Kanban Task App** đã được dựng sẵn cấu trúc. Project sử dụng:
- React 18 + Vite
- React-Bootstrap 2.x
...
|------|-----------|------|------|
| TODO-01 | Alert khi đăng nhập sai / Phân quyền giao diện theo role | `Login.jsx` + `TaskList.jsx` | 1,0 |
| TODO-02 | Hiển thị thông tin người dùng trên Navbar | `AppNavbar.jsx` | 1,0 |
| TODO-03 | Nút Logout hoặc Dropdown sắp xếp | `AppNavbar.jsx` + `TaskList.jsx` | 1,0 |
| TODO-04 | Dropdown Form thêm mới | `AddTask.jsx` | 1,0 |
| TODO-05 | Trang chi tiết thực thể (Detail Page) | `TaskDetail.jsx` | 1,0 |
| TODO-06 | Xóa thực thể kèm ModalConfirm | `TaskRow.jsx` | 1,0 |
| TODO-07 | Định dạng cột dữ liệu trên dòng | `TaskRow.jsx` | 0,5 |
| TODO-08 | Footer hiển thị động | `AppFooter.jsx` | 0,5 |
| TODO-09 | Trang 404 hoặc Fetch song song | `NotFound.jsx` hoặc `ProjectDetail.jsx` | 1,0 |
| TODO-10A | Thêm danh mục | `ManageProjects.jsx` | 1,0 |
| TODO-10B | Chặn xóa danh mục đang sử dụng | `ManageProjects.jsx` | 1,0 |
| **Tổng** | | | **10,0** |
...
- **TaskList.jsx**: Lấy user từ AuthContext. Nếu role != 'Admin' thì ẩn nút "+ Add" và truyền canManage={false} xuống Row để ẩn nút Delete.
...
- Gọi fetchProjects() trong useEffect để đổ dữ liệu vào Dropdown chọn loại. Option đầu tiên là placeholder có value="".

### TODO-05 — Chi tiết thực thể
- Gọi API fetchTaskById, hiển thị Spinner khi loading, hiển thị Alert khi lỗi, hiển thị chi tiết thực thể và có nút Back.
