...
Bạn nhận được một project **Event Planner App** đã được dựng sẵn cấu trúc. Project sử dụng:
- React 18 + Vite
- React-Bootstrap 2.x
...
|------|-----------|------|------|
| TODO-01 | Alert khi đăng nhập sai / Phân quyền giao diện theo role | `Login.jsx` + `EventList.jsx` | 1,0 |
| TODO-02 | Hiển thị thông tin người dùng trên Navbar | `AppNavbar.jsx` | 1,0 |
| TODO-03 | Nút Logout hoặc Dropdown sắp xếp | `AppNavbar.jsx` + `EventList.jsx` | 1,0 |
| TODO-04 | Dropdown Form thêm mới | `AddEvent.jsx` | 1,0 |
| TODO-05 | Trang chi tiết thực thể (Detail Page) | `EventDetail.jsx` | 1,0 |
| TODO-06 | Xóa thực thể kèm ModalConfirm | `EventRow.jsx` | 1,0 |
| TODO-07 | Định dạng cột dữ liệu trên dòng | `EventRow.jsx` | 0,5 |
| TODO-08 | Footer hiển thị động | `AppFooter.jsx` | 0,5 |
| TODO-09 | Trang 404 hoặc Fetch song song | `NotFound.jsx` hoặc `LocationDetail.jsx` | 1,0 |
| TODO-10A | Thêm danh mục | `ManageLocations.jsx` | 1,0 |
| TODO-10B | Chặn xóa danh mục đang sử dụng | `ManageLocations.jsx` | 1,0 |
| **Tổng** | | | **10,0** |
...
- **EventList.jsx**: Lấy user từ AuthContext. Nếu role != 'Admin' thì ẩn nút "+ Add" và truyền canManage={false} xuống Row để ẩn nút Delete.
...
- Gọi fetchLocations() trong useEffect để đổ dữ liệu vào Dropdown chọn loại. Option đầu tiên là placeholder có value="".

### TODO-05 — Chi tiết thực thể
- Gọi API fetchEventById, hiển thị Spinner khi loading, hiển thị Alert khi lỗi, hiển thị chi tiết thực thể và có nút Back.
