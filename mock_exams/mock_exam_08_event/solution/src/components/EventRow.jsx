...
export default function EventRow({ event, index, onDelete, canManage }) {
  ...
  return (
    <tr>
      ...
      <td>
        {formatVND(event.priceWeekday)}
        
              </td>
      <td>
        <div className="d-flex gap-2">
          <Link to={`/events/${event.id}`} className="btn btn-sm btn-info text-white">
            View
          </Link>
