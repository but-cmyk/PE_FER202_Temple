...
Bạn nhận được một project **Freelance App** đã được dựng sẵn cấu trúc. Project sử dụng:
- React 18 + Vite
- React-Bootstrap 2.x
...
|------|-----------|------|------|
| TODO-01 | Alert khi đăng nhập sai / Phân quyền giao diện theo role | `Login.jsx` + `GigList.jsx` | 1,0 |
| TODO-02 | Hiển thị thông tin người dùng trên Navbar | `AppNavbar.jsx` | 1,0 |
| TODO-03 | Nút Logout hoặc Dropdown sắp xếp | `AppNavbar.jsx` + `GigList.jsx` | 1,0 |
| TODO-04 | Dropdown Form thêm mới | `AddGig.jsx` | 1,0 |
| TODO-05 | Trang chi tiết thực thể (Detail Page) | `GigDetail.jsx` | 1,0 |
| TODO-06 | Xóa thực thể kèm ModalConfirm | `GigRow.jsx` | 1,0 |
| TODO-07 | Định dạng cột dữ liệu trên dòng | `GigRow.jsx` | 0,5 |
...
- **GigList.jsx**: Lấy user từ AuthContext. Nếu role != 'Admin' thì ẩn nút "+ Add" và truyền canManage={false} xuống Row để ẩn nút Delete.
...
- Thêm dropdown sắp xếp (Sort by) Name / Delivery Time (days) / Price (tăng/giảm). Cập nhật phân trang và set page = 1.
...
- Gọi API fetchGigById, hiển thị Spinner khi loading, hiển thị Alert khi lỗi, hiển thị chi tiết thực thể và có nút Back.
