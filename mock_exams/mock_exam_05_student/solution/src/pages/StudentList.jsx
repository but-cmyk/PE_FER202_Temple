...
export default function StudentList() {
  ...
  const { students, departments, loading } = state
      ...
      <Row className="mb-3 align-items-center">
        ...
        <Col md={3}>
          {/* TODO-03: Dropdown Form.Select sắp xếp với aria-label="Sort by" */}
            ...
            <option value="num-asc">GPA (Low-High)</option>
            <option value="num-desc">GPA (High-Low)</option>
      ...
      <Table striped bordered hover>
        ...
        <tbody>
          {paginatedItems.map((item, idx) => (
            // TODO-01: Truyền canManage={isAdmin} xuống StudentRow
                        <StudentRow
              key={item.id}
              student={item}
